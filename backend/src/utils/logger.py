# src/utils/logger.py
"""
Logger for Personel Knowledge Agent App.

Set the following environment variables to control logging:
- LOG_LEVEL: console verbosity (CRITICAL, ERROR, WARNING, INFO, DEBUG)
- LOG_DIR: custom directory for log files (default: 'logs')
...
def configure_logging(settings):
    """
    Configure global logging for the agent.
